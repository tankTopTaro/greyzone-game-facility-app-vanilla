...
const Controls = ({ wsService, clients, activePlayers, recentPlayers, scannedPlayers, gameRoomEnabled, setShowToast, setToastMessage, setToastVariant, searchAttempted, setSearchAttempted, players, setPlayers}) => {
